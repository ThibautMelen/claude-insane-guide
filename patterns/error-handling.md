...
- 📄 [MCP Guide](../themes/4-mcp/guide.md) - Configuration MCP servers
- 📄 [Hooks Guide](../themes/6-hooks/guide.md) - Automation avec hooks
- 📄 [Interactive UI](../themes/10-interactive/guide.md) - AskUserQuestion patterns
